# Contributing to can-zone-storage
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-zone-storage) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-zone-storage, you can start by going to its [fork page](https://github.com/canjs/can-zone-storage/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-zone-storage
```
